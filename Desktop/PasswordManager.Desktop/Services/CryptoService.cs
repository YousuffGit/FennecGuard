...
public class CryptoService
{
    ...
    public const int NonceSizeInBytes = 12; // 96 bits for AES-GCM
    public const int TagSizeInBytes = 16;   // 128-bit authentication tag
    public const int SaltSizeInBytes = 16;  // 128-bit salt

    // Derives a 256-bit symmetric encryption key using Argon2id
